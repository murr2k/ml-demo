...
function setupTrajectoryChart(lc) {
    ...
    return {
        addAgent(agent) {
            ...
            predictionSeries.setStrokeStyle(
                stroke => stroke.setThickness(2).setFillStyle(fill => fill.setA(128)) // Semi-transparent
            )
        ...
        updateAgentPosition(agentId, position) {
            ...
            if (agent.data.length > 1) {
                ...
                trail.setStrokeStyle(stroke => stroke.setThickness(1).setFillStyle(fill => fill.setA(64)))
